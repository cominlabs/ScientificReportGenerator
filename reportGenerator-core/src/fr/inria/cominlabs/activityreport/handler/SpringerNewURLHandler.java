...
public class SpringerNewURLHandler {

	
	/**
	 *  This method returns the download link of a given Springer (new web site) article. 
	 ...
	 */
	public static String get_download_link(String targetUrl) {
	...
	/**
	 *  This method returns the pdf download link of a given Springer (new web site) article.
	 ...
	 */
	private static String filterResult(InputStream is, URL url) {
